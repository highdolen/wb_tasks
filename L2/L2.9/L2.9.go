...
// функция возвращает ошибку при некорректной строке (например, начинается с цифры)
func Unpack(input string) (string, error) {
	...
	// result будет аккумулировать итоговые руны (результат распаковки)
	var result []rune
...
func main() {
	...
	tests := []string{
		...
		`qwe\45`,   // \4 = '4', затем 5 -> '4' повторяется 5 раз
		"aaa0b",    // 'a' с 0 удаляет предыдущий 'a'
		`a\\b`,     // двойной слэш: первый экранирует второй => в результате "a\b"
